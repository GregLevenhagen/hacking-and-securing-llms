"""Test fixtures for Demo 7 — imports shared mock fixtures and adds demo-specific ones."""
...
# Ensure demo python dir is on sys.path for local imports (retrieval_defenses)
