"""Test fixtures for Demo 15 — imports shared mock fixtures and adds demo-specific ones."""
...
# Ensure demo python dir is on sys.path for local imports (xss_attacks, output_renderer)
