"""Test fixtures for Demo 3 — imports shared mock fixtures and adds demo-specific ones."""
...
# Ensure demo python dir is on sys.path for local imports (build_index, query_rag, etc.)
