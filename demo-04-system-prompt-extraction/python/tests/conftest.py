"""Test fixtures for Demo 4 — imports shared mock fixtures and adds demo-specific ones."""
...
# Ensure demo python dir is on sys.path for local imports (chatbot, extraction_attacks)
